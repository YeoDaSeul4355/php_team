...
<body>
    ...
    <div class="tab__menu">
        <div class="tab__inner">
            <h1>비문학</h1>
            <p>하루 한 지문에서 준비한<br>비문학 지문입니다.</p>
        </div>
    </div>
    <!-- tab -->
    <main id="main" class="center">
        <div class="board__inner container mt30">
            <div class="sub__list mb30">
                ...
                <a class="category-link" data-category="인문">인문</a>
                <a class="category-link" data-category="사회">사회</a>
                <a class="category-link" data-category="과학">과학</a>
                <a class="category-link" data-category="기술">기술</a>
                <a class="category-link" data-category="예술">예술</a>
            </div>
            <div class="board__table">
                <table>
                    ...
                    <?php
                        $questions = [
                            ['[2014년도]', '예술', '수능', '중'],
                            ['[2018년도]', '사회', '고3 3월 모의고사', '하'],
                            ['[2020년도]', '사회', '고1 6월 모의고사', '중'],
                            ['[2023년도]', '과학', '고3 6월 모의고사', '상'],
                            ['[2014년도]', '인문', '수능', '상'],
                            ['[2015년도]', '기술', '고2 11월 모의고사', '중'],
                            ['[2015년도]', '과학', '고2 11월 모의고사', '하'],
                            ['[2016년도]', '사회', '고1 6월 모의고사', '상'],
                            ['[2017년도]', '인문', '고2 11월 모의고사', '상'],
                            ['[2017년도]', '예술', '고2 11월 모의고사', '하'],
                            ['[2023년도]', '과학', '고1 6월 모의고사', '하'],
                            ['[2008년도]', '과학', '고3 9월 모의고사', '중'],
                            ['[2021년도]', '기술', '고1 6월 모의고사', '상'],
                            ['[2015년도]', '인문', '고3 6월 모의고사', '중'],
                            ['[2012년도]', '사회', '고2 7월 모의고사', '하'],
                            ['[2011년도]', '예술', '수능', '상'],
                            ['[2013년도]', '인문', '수능', '하'],
                            ['[2011년도]', '예술', '고1 3월 모의고사', '하'],
                            ['[2016년도]', '사회', '고2 11월 모의고사', '중'],
                            ['[2016년도]', '과학', '고2 11월 모의고사', '중'],
                        ];
                        // 현재 페이지 번호
                        ...
                        for ($i = 0; $i < count($currentPageItems); $i++) {
                            ...
                            $url = "questionView.php?id=$id"; // 문제를 표시하는 페이지의 URL 생성
                            ?>
