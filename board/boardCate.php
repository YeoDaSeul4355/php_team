<?php
    ...
    $categorySql = "SELECT * FROM swBoard WHERE boardDelete = 0 AND boardCategory = '$category' ORDER BY swBoardID DESC";
    ...
    <main id="main" class="center">
        ...
        <div class="board__inner container">
            <div class="board__head">
                ...
                <h2><a href="board.php">전체 게시판</a></h2><em>></em>
                <h2><a href="boardCate.php?category=<?php echo urlencode($category); ?>"><span><?php echo htmlspecialchars($category, ENT_QUOTES, 'UTF-8'); ?></span></a></h2>
            </div>
...
<?php
    ...
    $sql = "SELECT b.swBoardID, b.boardCategory, b.boardTitle, m.youNick, b.boardRegTime, b.boardView
            FROM swBoard b
            JOIN swMember m ON (b.swMemberID = m.swMemberID)";
    if($category != ""){
        $sql .= " WHERE b.boardCategory = '$category'";
    }
    $sql .= " ORDER BY swBoardID DESC
