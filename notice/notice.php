...
<?php
    ...
    if($page != 1 && $page <= $noticeTotalCount){
        ...
        echo "<li><a href='notice.php?page={$prevPage}'><img src='../html/assets/img/arrow2.png' alt='이전'></a></li>";
    }
    ...
    if($page < $totalPages){
        $nextPage = $page + 1;
        echo "<li><a href='notice.php?page={$nextPage}'><img src='../html/assets/img/arrow3.png' alt='다음'></a></li>";
